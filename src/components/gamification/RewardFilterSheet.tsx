...
import { dealerRewardStatus, type RewardStatus } from "@/lib/gamification";
...
export function applyRewardFilters<T extends { status: RewardStatus; physical?: boolean }>(
  list: T[],
  filters: RewardFilters
): T[] {
  if (filters.status === "All") return list;
  return list.filter((r) => dealerRewardStatus(r) === filters.status);
}
