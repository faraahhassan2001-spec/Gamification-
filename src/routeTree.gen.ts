...
import { Route as SpinIndexRouteImport } from './routes/spin.index'
...
const SpinIndexRoute = SpinIndexRouteImport.update({
  id: '/spin/',
  path: '/spin/',
  getParentRoute: () => rootRouteImport,
} as any)
...
export interface RootRouteChildren {
  ...
  SpinIndexRoute: typeof SpinIndexRoute
}
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/spin/': {
      ...
      path: '/spin'
      fullPath: '/spin/'
      preLoaderRoute: typeof SpinIndexRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/spin/history': {
      id: '/spin/history'
